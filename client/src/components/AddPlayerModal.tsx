    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white border border-[#e2e0db] rounded w-full max-w-md">
        ...
        <div className="flex items-center justify-between p-6 border-b border-[#e2e0db]">
          <h2 className="font-display font-semibold text-zinc-900">Add Player to Event</h2>
        ...
        <div className="p-4 border-b border-[#e2e0db]">
          <input
            className="input"
        ...
        {error && (
          <div className="mx-4 mt-3 bg-red-50 border border-red-100 text-red-700 text-sm px-3 py-2 rounded">
            {error}
          </div>
        )}
        ...
        <div className="max-h-72 overflow-y-auto py-2">
          {loading ? (
            ...
            available.map((player) => (
              <div
                key={player.id}
                className="flex items-center justify-between px-4 py-3 hover:bg-[#f5f3ee] transition-colors"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {player.email && <p className="text-xs text-zinc-400">{player.email}</p>}
                  </div>
                </div>
                <button
        ...
        <div className="p-4 border-t border-[#e2e0db] flex justify-between items-center">
